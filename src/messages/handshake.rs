...
mod spec {
    ...
    pub use reader::HsSpecReaderError;
    pub use writer::HsSpecWriterError;
    pub(super) use reader::HSSpecReader;
    pub(super) use writer::HSSpecWriter;
    ...
    mod reader {
        ...
        use crate::features::FeaturesError;
    ...
    mod writer {
        ...
        use crate::models::ModelSerializeError;
        use crate::features::FeaturesError;
